...
export default function Tickets(
  ...
  return (
    <div
      className=" border-2 border-gray-300 my-10 xs:my-4 p-6 w-full rounded-xl hover:scale-105 duration-300 ease-in-out cursor-pointer"
      onClick={() => navigate(`/ticket/${ticket.id}`)}
    >
      <div className="flex justify-between xs:flex-col items-center w-full px-8 my-2">
        ...
        <img
          ...
          alt="S7 logo"
          className=" w-24 h-auto" //w-1/4 sm:w-4/12 xxs:w-5/6
        />
      </div>
